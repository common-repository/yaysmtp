...
class QuerySerializer
{
    ...
    public function __construct(\YaySMTP\Aws3\Aws\Api\Service $api, $endpoint, callable $paramBuilder = null)
    {
        ...
        $this->paramBuilder = $paramBuilder ?: new \YaySMTP\Aws3\Aws\Api\Serializer\QueryParamBuilder();
    }
    /**
    ...
    public function __invoke(\YaySMTP\Aws3\Aws\CommandInterface $command)
    {
        ...
        return new \YaySMTP\Aws3\GuzzleHttp\Psr7\Request('POST', $this->endpoint, ['Content-Length' => strlen($body), 'Content-Type' => 'application/x-www-form-urlencoded'], $body);
    }
}
